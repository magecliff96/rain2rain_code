...
def parse_args():
    ...
    parser.add_argument('-dgt', '--data-gt', help='dataset root path', default='../data')
    ...
    parser.add_argument('-n', '--noise-type', help='noise type',
        choices=['gaussian', 'poisson', 'text', 'mc', 'none', 'rain'], default='gaussian', type=str)
...
if __name__ == '__main__':
    ...
    test_loader = load_dataset(params.data, params.data_gt, 0, params, shuffled=False, single=True)

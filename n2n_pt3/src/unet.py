...
class UNet(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=3):
        ...
        self.ddc1= nn.Conv2d(48, 48, kernel_size=(3,1), stride=1, padding=(1,0), bias=False)
    ...
    def forward(self, x):
        ...
        #ddc
        mege11=F.relu(self.bn48(self.ddc1(pool1)))
        mege12=F.relu(self.bn48(self.ddc2(pool1)))
        mege13=F.relu(self.bn48(self.ddc3(pool1)))
        ...
        concat2 = torch.cat((upsample2, pool1, mege11, mege12, mege13), dim=1)
        upsample1 = self._block5m(concat2)

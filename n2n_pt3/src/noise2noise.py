...
class Noise2Noise(object):
    ...
    def eval(self, valid_loader):
        ...
        for batch_idx, (source, target) in enumerate(valid_loader):
            ...
            # Update loss
            loss = self.loss(source_denoised, target)# + self.loss2(source_denoised, target) + self.loss3(source_denoised, target))#edited
...
class L0Loss(nn.Module): #edited dc loss
    """High dynamic range loss."""

...
def montages(img_name, save_path, source_t, denoised_t, clean_t, show):
    """Creates montage for easy comparison."""
    ...
    # Save to files
    fname = os.path.splitext(img_name)[0]
    source.save(os.path.join(save_path, f'{fname}-1.png'))
    denoised.save(os.path.join(save_path, f'{fname}-2.png'))
